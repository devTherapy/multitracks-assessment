<%@ Page Language="C#" AutoEventWireup="true" CodeFile="artistDetails.aspx.cs" Inherits="ArtistDetails" EnableViewState="false" %> 
			...
			<div class="wrapper mod-standard mod-gray">
				<div class="details-banner">
					...
					<div class="details-banner--hero">
						<<asp:Image runat="server" class="details-banner--hero--img" ID="heroImage" 
						ImageUrl="./img/31.jpg"	
                        Attributes="srcset='./img/31.jpg, ./img/31.jpg 2x'" alt="" />
					</div>
					<div class="details-banner--info">
						<a href="#" class="details-banner--info--box">
								<asp:Image class="details-banner--info--box--img"
								 runat="server"
								 ID="bannerImage"
                            ImageUrl="./img/174-sm.jpg"
                            Attributes="srcset='./img/174-sm.jpg,
								 			./img/174.jpg 2x'"
                            alt="alt" />
						</a>
                    <h1 class="details-banner--info--name"><a class="details-banner--info--name--link" href="#">
                        <asp:Literal runat="server" ID="BannerName" /></a></h1>
					</div>
				</div>
...
<%-- ---------------------------------------------------------songs--------------------------- --%>
									<ul id="playlist" class="song-list mod-new mod-menu">
										<asp:Repeater ID="SongsList" runat="server">
											<ItemTemplate>
													<li class="song-list--item media-player--row">

														<div class="song-list--item--player-img media-player">
															<img class="song-list--item--player-img--img" 
                                                srcset='<%#Eval("albumImage")%>'
                                                src='<%#Eval("albumImage") %>' alt='<%#Eval("title") %>'>
														</div>
...
<%-- ---------------------------------------------------------songs--------------------------- --%>
                    ...
                    <!-- /.songs-section -->
                        ...
                        <!-- /.discovery-section-header -->
                            ...
                            <p>
                                <asp:Literal ID="Bio" runat="server"></asp:Literal>
                            </p>
